...
We considered different scenarios for *monitoring* the fishing activity and *reviewing* the monitoring data. We use the term *monitor* to refer to vessels/trips/sets that had human observers or electronic monitoring present. We use the term *coverage* to indicate the percentage of the sets in a year that were monitored We use the term *review* to refer to monitoring data that was obtained and analyzed (e.g. not all electronic video is reviewed[\[VS1\]](#_msocom_1) ).. Review was always of whole sets.

In total, we simulated seven scenarios the span various monitoring and review configurations. Each scenario [\[VS2\]](#_msocom_2) was based on reviewing whole sets, whole trips, or whole vessels.

 [\[VS1\]](#_msoanchor_1)I don’t understand this.

 [\[VS2\]](#_msoanchor_2)The “monitoring scenarios” haven’t been introduced yet so this may not make sense. Consider moving this to the section where they are introduced.Reviewing whole sets at random
...
All parameters were chosen to be representative of the Western Pacific longline tuna fleets, data given in @brown2021electronic, parameters are in Table S3.
