...
We created a computer simulation that modeled a fictional longline tuna fishing fleet with 50 vessels, based on dynamics of an actual fleet  [e.g. @brown2021electronic]. The fictional fishery's manager has to make a decision about how to allocate monitoring and review of data for the coming year. We assumed the manager knew the number of vessels, but not the amount of fishing they would do or how much they would catch.
